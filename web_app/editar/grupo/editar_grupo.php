...
if ($_SESSION['logado'] == $chave) {
    ...
    <body onLoad="focus_grupo()">
        <div id="tamanho" align="center"><br>
            ...
            $busca = mysql_query("SELECT * FROM grupo WHERE id_grupo = '$editar' ") or die("Não foi possivel localizar o grupo. " . mysql_error());
                ...
                <div align="center">
                    ...
                    <div id="inc_agenda">
                        <table>
                            <tr>
                                <td>
                                    <div id="tit_send_grupo"><br>Digite um novo nome para o grupo</div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <form action="editar_grupo_bd.php?cod=<?php echo $editar; ?>" method="post">
                                        <input type="text" name="edita_grupo" required id="edita_grupo" value="<?php echo $lista['grupo'] ?>">
                                        <div id="btn_env_sms_grupo">
                                            <input type="submit" value="Salvar Edição" id="btngrupo">
                                        </div>
                                    </form>
                                </td>
                            </tr>
