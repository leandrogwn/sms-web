        ...
        <div id="tamanho" align="center">
            ...
            <div id="pop">
                ...
                <div align="center">
                    ...
                    <form action="../../cadastrar/grupo/cad_grupo_bd.php?tela=edicao" method="post">
                        ...
                        <td> 
                            ...
                            if ($lista_user == $id_user_sessao) {
                                ...
                                <form action="editar_municipe_bd.php" method="post"> 
                                    ...
                                    <input type="date" name="data_n" id="data" required value="<?php echo $listaMunicipe['data_nasc']; ?>">&nbsp;
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="checkboxes">
                                            <?php
                                            $listaGrupo = mysql_query("SELECT * FROM grupo ORDER BY grupo ASC") or die("Não foi possivel carregar os dados da tabela" . mysql_error());
                                    ...
                                    <fieldset>
                                        ...
                                        <input type="text" placeholder="Fone SMS" name="fone_sms" required id="fonesms" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4}" placeholder="Fone SMS" value="<?php echo $listaFone['fone_sms'] ?>">
                                        <input type="text" placeholder="Fone Fixo" name="fone_fixo" id="fone1" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4}" value="<?php echo $listaFone['fone_fixo'] ?>" >&nbsp;
                                        <input type="text" placeholder="Fone Recado" name="fone_recado" id="fone2" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4}" value="<?php echo $listaFone['fone_recado'] ?>" >
                                    </fieldset>
