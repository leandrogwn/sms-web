                ...
                <table align="center" cellpadding="4">
                    ...
                    while ($lista = mysql_fetch_assoc($busca)) {
                        ...
                        if ($cor == 0) {
                            ...
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $lista['nome'] ?></td>
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo validata($lista['data_nasc']) ?></td>
                            <td style="text-transform:lowercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $lista['email'] ?></td>
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $registroEndereco['rua'] . ', ' . $registroEndereco['numero']; ?></td>
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $registroTelefone['fone_sms'] ?></td>
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $registroTelefone['fone_fixo'] ?></td>
                            <td style="text-transform:uppercase; font:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size:12px;"><?php echo $registroTelefone['fone_recado'] ?></td>
                            <td>
